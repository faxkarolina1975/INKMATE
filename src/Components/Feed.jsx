    ...
    <div style={{ backgroundColor: "#8f41c4"}}>
      <div className="position-relative overflow-hidden p-3 row">
        <div className="col-md-6 p-lg-5 ">
            <h1 className="display-4 fw-normal" style={{color: "white"}}>Tattoo Center Nombre</h1>
            <p className="lead fw-normal" style={{color: "#23001E"}}>Localizacion</p>
            <p className="lead fw-normal" style={{color: "#23001E"}}>Horario de la Semana</p>
            <i class="bi bi-star-fill" style={{color: "#23001E"}}>5.0</i>
        </div>
        <div className="col-md-6 p-lg-5">
            <img className="img-fluid" src="src/assets/image.jpg" alt="Chania" width="90%"></img>
        </div>
  </div>
